...
public class PdfRendererFragment extends Fragment implements View.OnClickListener {
    ...
    private static final String FILENAME_PARAM = "pdfFilename";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            FILENAME = getArguments().getString(FILENAME_PARAM);
        }
...
//    }
    ...
    public void onStart() {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(getActivity(), "File Not Found: " + FILENAME, Toast.LENGTH_SHORT).show();
